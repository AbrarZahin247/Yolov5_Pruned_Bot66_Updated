...
#         self.gamma = nn.Parameter(torch.ones(conv_layer.out_channels).to(conv_layer.weight.device))

#     def forward(self, x):
#         out = self.conv(x)
#         out = out * self.gamma.view(1, -1, 1, 1)  # Apply scaling factor γ to each channel
#         return out
